...
import MySQLdb
from src.datadefs import ParticipantBrewerRecord
...
def create_entries(participant: ParticipantBrewerRecord):
    ...
    VALUES (
        ...
        %s
            ...
            (
                entry.name,
                style.brew_style_name,
                style.brew_cat(),
                style.brew_cat_sort(),
                style.brew_style_num,
                brew_info,
                participant.first_name,
                participant.last_name,
                participant.user_account.user_id,
                1,
                1,
                brew_judging_no,
...
def participant_exists(participant: ParticipantBrewerRecord) -> bool:
    ...
    cur.execute(
        "SELECT COUNT(*) FROM brewer WHERE brewerFirstName = %s AND brewerLastName = %s",
        (
            participant.first_name,
            participant.last_name,
        ),
